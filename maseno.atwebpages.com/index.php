...
<hr   style="clear: both;">
<span class="text-center d-flex justify-content-center text-success"> HOUSES</span>
...
functionAlert();
 ...
 $(document).ready(function(){
    ...
    $.get("house_components/search_home_page.php", {searchvalue: inputVal }).done(
               function(data){
...
{ 
  ...
  $.ajax({
type: 'POST',
url: 'house_components/fetch_house_for_homepage.php',
...
{ 
  ...
  $.ajax({
type: 'POST',
url: 'house_components/fetch_lands_for_homepage.php',
