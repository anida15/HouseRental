...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home</a><i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i> Change Password </strong> </span>
...
<div class="text-success m-4" > 
  <h6 style="text-align: center;"><u> Change Password</u></h6>
</div>
...
<div class="col-lg-8">
       ...
       <div  class="mb-4" style="border: yellow solid 1px ;border-radius: 10px; margin-top:10px ;  background-image: linear-gradient(to bottom right ,black,green); padding:10px;">
                   ...
                   <div class=" d-flex justify-content-center">
                       ...
                       <div class="input-container">
                            <input style="border: white solid 1px;" placeholder="New Password" type="password" class="input-field" id="new_password"  >

                          </div>

 
                       <div class="input-container">
                            <input style="border: white solid 1px;    width: 300px;" placeholder="Confirm" type="password" class="input-field " id="c_password"  >
...
var new_password = document.forms["send_message"]["new_password"].value;
var c_password = document.forms["send_message"]["c_password"].value;
...
if(new_password == ""){
    ...
    <span class="text-light" style="font-size:12px;">Please Enter New password</span>
    </div>
