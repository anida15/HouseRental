...
<span class="text-success"><strong><a href="index.php" class="text-success">Home</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i>Fan and Facts </strong></span>
...
<div class="text-success m-4 " > 
  <h6 style="text-align: center;"><u> SEND FAN AND FACTS</u></h6>
       ...
       <div style="border: yellow solid 1px ;border-radius: 10px; margin-top:10px ;  background-image: linear-gradient(to bottom right ,black,green); padding:10px;">
                   ...
                   <div class=" d-flex justify-content-center">
                    ...
                    <div class=" d-flex justify-content-center">
                       ...
                       <div class="input-container">
                            <textarea style="border: white solid 1px; width:300px;  height:150px;" placeholder="Message..."  class="input-field" id="message"  ></textarea>
...
$.ajax({xhr: function() {
                          ...
                          url: 'message_settings/send_facts.php ',
                          type: 'post',
                          data: fd,
                          contentType: false,
                          processData: false,
