...
$query =mysqli_query($conn,"SELECT * FROM  book_land  WHERE   status ='YES'" );
...
<span class="text-success"><strong><a href="index.php" class="text-success">Home</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"></i>Completed Land Request</strong></span>
...
<div class="text-success m-4" > 
  <h6 style="text-align: center;"><u>Completed Booking Land Request</u></h6>
</div>
...
<?php while($result=mysqli_fetch_assoc($query)){?>
            <tr>
                        ...
                        <td> <button class="btn btn-outline-success " style="font-size:smaller" ><a   class="text-success"  href="view_land_request.php?book_code=<?php echo $result['book_code']; ?>" >Completed <i class="fa fa-check" style="font-size:20px;color:greeen"></i></a></button> <br> <sup style="z-index: 9; position:relative;" ><?php echo $result['time_update']; ?></sup>
                        </td>
...
$(document).on('click', '.return_order', function(){
  ...
  $.ajax({
type: 'POST',
url: 'book_request/send_uncomplete_land_request.php',
