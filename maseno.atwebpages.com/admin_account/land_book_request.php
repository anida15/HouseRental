...
$query =mysqli_query($conn,"SELECT * FROM  book_land  WHERE   status ='NO'" );
...
<span class="text-success"><strong><a href="index.php" class="text-success">Home</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"></i> land Request  </strong></span>
...
<div class="text-success m-4" > 
  <h6 style="text-align: center;"><u>Land Book Request</u></h6>
</div>
...
<?php while($result=mysqli_fetch_assoc($query)){?>
            <tr>
                        ...
                        <td> <button class="btn btn-warning " style="font-size:smaller" ><a   href="view_land_request.php?book_code=<?php echo $result['book_code']; ?>">Details</a></button>
                        </td>
...
$(document).on('click', '.complete', function(){
  ...
  $.ajax({
type: 'POST',
url: 'book_request/send_land_complete_request.php',
