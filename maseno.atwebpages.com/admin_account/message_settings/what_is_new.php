...
$query = mysqli_query($conn,"SELECT * FROM  what_is_new ORDER BY time_update DESC");
...
<tbody><tr> <td width="100%" style="text-align:center;  "><span class="text-danger"> Not Available</span> </td></tr>
</tbody>
</table>
...
<div class="d-flex justify-content-end"> 
  <button  class=" btn btn-outline-danger delete" data-id="<?php echo $result['id']; ?>" data-file_location="<?php echo $result['file_storage_location']; ?>"> DELETE</button> 
 </div>
...
<p class="card-text"> <img src="../../<?php echo $result['file_storage_location']; ?>" width="100%" height="270px" alt=""> </p>
...
$.ajax({
type: 'POST',
url: 'delete_what_is_new.php',
data:{id:id,file_location:file_location},
