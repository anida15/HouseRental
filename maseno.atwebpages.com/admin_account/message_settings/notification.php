...
$query = mysqli_query($conn,"SELECT * FROM notification  ORDER BY time_update DESC");
...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home </a><i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i>All Notifications </strong> </span>
...
<tbody><tr> <td width="100%" style="text-align:center;  "><span class="text-danger"> No Notification Available</span> </td></tr>
</tbody>
</table>
