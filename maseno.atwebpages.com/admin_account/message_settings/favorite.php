...
$query = mysqli_query($conn,"SELECT * FROM  favorite ORDER BY time_update DESC");
...
<tbody><tr> <td width="100%" style="text-align:center;  "><span class="text-danger"> No Favorite </span> </td></tr>
</tbody>
</table>
