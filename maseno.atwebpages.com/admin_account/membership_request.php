...
$query =mysqli_query($conn,"SELECT * FROM membership_application WHERE pending_application='1' AND status ='YES'" );
...
<span class="text-success"><strong><a href="index.php" class="text-success">Home</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"></i> Membership Requests </strong></span>
...
<div class="text-success m-4" > 
  <h6 style="text-align: center;"><u>Membership Request</u></h6>
</div>
...
<?php while($result=mysqli_fetch_assoc($query)){?>
            <tr>
                        ...
                        <td><?php  if($result['applicant_phone']){
                        ...
                        <td> <button class="btn btn-success Approve "  data-username="<?php echo $result['username']; ?>">Approve</button>
                        </td>
                        <td> <button class="btn btn-danger  Reject "   data-username="<?php echo $result['username']; ?>">Reject</button>
                        </td>
...
$(document).on('click', '.Approve', function(){
  ...
  $.ajax({
type: 'POST',
url: 'membership_process/approved_request.php',
