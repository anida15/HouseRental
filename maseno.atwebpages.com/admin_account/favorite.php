...
<span class="text-success"><strong><a href="index.php" class="text-success">Home</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i>Send favorite </strong></span>
...
<div class="text-success m-4" > 
  <h6 style="text-align: center;"><u> SEND FAVORITE</u></h6>
</div>
...
$.ajax({xhr: function() {
                          ...
                          url: 'message_settings/send_favorite.php',
                          type: 'post',
                          data: fd,
                          contentType: false,
                          processData: false,
