...
<span class="text-success"><strong><a href="index.php" class="text-success">Home</a> </strong> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i><strong> <?php echo $_GET['bedroom']  ?> Bedroom   </span>
...
$(document).ready(function(){
    ...
    $.get("house_components/search_home_page.ph", {searchvalue: inputVal }).done(
               function(data){
...
{ 
  ...
  $.ajax({
type: 'POST',
url: 'house_components/fetch_air_bnb.php',
