...
<span class="text-success"><strong><a href="index.php" class="text-success">Home</a>  <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i> <?php echo $_GET['category']; ?>  <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i> <?php echo $_GET['bedroom']; ?> Bedroom <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i> <?php echo $_GET['property']; ?>  </strong></span>
...
{ 
      var  bedroom="<?php echo $_GET['bedroom']; ?>"
  ...
  $.ajax({
type: 'POST',
url: 'house_components/fetch_catergory.php',
data:{property_type:property_type,category:category,bedroom:bedroom },
