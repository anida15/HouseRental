...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home </a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i> House Photos  </strong></span>
...
{ 
  ...
  $.ajax({
type: 'POST',
url: 'house_components/fetch_view_house_photos.php',
