...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home  </a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i> <strong><a href="lands.php" class="text-success"> Land  </a></strong> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i> Land Photos   </strong></span>
...
{ 
  ...
  $.ajax({
type: 'POST',
url: 'house_components/fetch_view_land_photos.php',
...
functionAlert();
 ...
 $(document).on('click', '.book_land', function(){
  var land_code = $(this).data('land_code');
 
  window.location='book_land.php?land_code='+land_code ;
