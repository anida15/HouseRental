...
$query_fetch_house= mysqli_query($conn,"SELECT * FROM house WHERE   house_code='{$house_code}' ");
...
$query_fetch= mysqli_query($conn,"SELECT * FROM house_extend_photos WHERE house_code='{$house_code}'   ");
                          ...
                          <tbody>
                             <tr> 
                               <td width="50%" style="  color:white; border:white solid 1px; border-left: none; font-size:13px; ">  
                                <a  id="delete_extend_house_post"     style="cursor:pointer"  data-house_code="'.$result_extend['extend_house_code'].'"  data-file_location="'.$result_extend['file_storage_location'].'"  >  <span class="text-primary"  >  <i class="fa fa-trash-o"   style="font-size:20px ;color:red;"></i> DELETE POST </span></a>
                               </td>
...
$query_fetch_video= mysqli_query($conn,"SELECT * FROM house_extend_video WHERE house_code='{$house_code}'   ");
...
<div class="card text-white bg-light border border-info mt-2 mb-2  "  >
       ...
       <div class="card-body bg-dark" >
                          ...
                          <tbody>
                             <tr> 
                               <td width="50%" style="  color:white; border:white solid 1px; border-left: none; font-size:13px; ">  
                                <a  id="delete_extend_house_video"     style="cursor:pointer"  data-house_code="'.$result_extend_video['extend_house_code'].'"  data-file_location="'.$result_extend_video['file_storage_location'].'"  >  <span class="text-primary"  >  <i class="fa fa-trash-o"   style="font-size:20px ;color:red;"></i> DELETE POST </span></a>
                               </td>
    ...
    <div class="card text-white bg-light border border-info mt-2 mb-2  "  >
           ...
           <div class="card-body bg-dark" >
                           ...
                           <div>
                             ...
                             <span   style="width:30%; float:right;" ><i class="fa fa-cart-arrow-down " style="font-size:15px;color:yellow"></i>  &nbsp; '.$result['category'].' </span>
                                ...
                                <table class="table mt-2 mb-"  >
                                 ...
                                 <a  id="view_house_photos"   style="cursor:pointer"  data-house_code="'.$result['house_code'].'"   >
                              ...
                              <tbody>
                                 <tr> 
                                   <td width="50%" style="  color:white; border:white solid 1px; border-left: none; font-size:13px; ">  
                                    <a  id="delete_house"     style="cursor:pointer"  data-house_code="'.$result['house_code'].'"  data-file_location="'.$result['file_storage_location'].'"  >  <span class="text-primary"  >  <i class="fa fa-trash-o"   style="font-size:20px ;color:red;"></i> DELETE POST </span></a>
                                   </td>
                                   <td width="50%" style=" color:white; border:white solid 1px;   border-right: none; font-size:13px; "> 
                                   <a  id="add_house_photo"   style="cursor:pointer"  data-house_code="'.$result['house_code'].'" data-property_type="'.$result['property_type'].'" >  <span class="text-primary"  >  <i class="fa fa-plus-square-o"   style="font-size:20px ;color:green;"></i> ADD PHOTO </span></a>
                                   
                                   </td>
                                  </tr>
                                  <tr> 
                                  <td width="50%" style="  color:white; border:white solid 1px;  border-bottom: none; border-left: none; font-size:13px; "> 
                                 <a  id="edit_house_post"  style="cursor:pointer"  data-house_code="'.$result['house_code'].'"   >  <span class="text-primary"  >  <i class="fa fa-edit"   style="font-size:20px ;color:green;"></i> EDIT DETAILS </span></a>
                                  
                                  </td>
                                  <td width="50%" style=" color:white; border:white solid 1px;  border-bottom: none;   border-right: none; font-size:13px; "> 
                                 <a  id="edit_house_photo"  style="cursor:pointer"  data-house_code="'.$result['house_code'].'"  data-property_type="'.$result['property_type'].'"   data-file_storage_location="'.$result['file_storage_location'].'" >  <span class="text-primary"  >  <i class="fa fa-edit"   style="font-size:20px ;color:green;"></i> EDIT PHOTO </span></a>
                           ...
                           <table class="table mt-2"  >
                                 ...
                                 <tr> 
                                 <td width="50%" style="   color:white; border:white solid 1px;  border-bottom: none;   font-size:13px; " class="text-center">
                                 <a  id="add_house_video"   style="cursor:pointer"  data-house_code="'.$result['house_code'].'" data-property_type="'.$result['property_type'].'" >  <span class="text-primary"  >  <i class="fa fa-plus-square-o"   style="font-size:20px ;color:green;"></i> ADD VIDEO </span></a>
                        ...
                        <div style=" position: absolute ;width: 95%;padding: 10px;background-color: black;border-radius:5px;z-index: 9;">
                             ...
                             <tbody>
                                <tr> 
                                 ...
                                 <tr> 
                                 <td width="50%" style="  color:white; border:white solid 1px; border-bottom: none; border-left: none; font-size:13px; ">Location &nbsp;   <i class="fa fa-caret-right" style="font-size:12px;color:red"></i> '.$result['location'].'</td>
