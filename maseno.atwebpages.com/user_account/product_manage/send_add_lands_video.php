...
if(isset($_POST['land_code'])){
       ...
       $extensions_arr = array("mkv","mp4","wmv","mov","avi");
            ...
            $newname =$rename.'.'.$extension;
             ...
             if(move_uploaded_file($_FILES['file']['tmp_name'],'../../upload/'.$newname)){
              ...
              $file_storage_location ='upload/'.$newname;
                    ...
                    $stmt = $conn->prepare("INSERT INTO land_extend_video (extend_land_code, land_code,username,file_storage_location) VALUES (?, ?, ?,?)");
                    $stmt->bind_param("ssss",$rename,$land_code,$username,$file_storage_location);
