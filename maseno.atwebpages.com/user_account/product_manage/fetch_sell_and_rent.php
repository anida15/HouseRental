...
$query_fetch_house= mysqli_query($conn,"SELECT * FROM house WHERE username='{$username}' ");
...
if(mysqli_num_rows($query_fetch_house)==0){
    ...
    <tbody><tr> <td width="100%" style="text-align:center;  "><span class="text-danger"> No House Available In Account</span> </td></tr>
    </tbody>
</table>
