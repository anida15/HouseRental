                          ...
                          <tbody>
                             <tr> 
                               <td width="50%" style="  color:white; border:white solid 1px; border-left: none; font-size:13px; ">  
                                <a  id="delete_extended_land_photo"     style="cursor:pointer"  data-land_code="'.$result_extend['extend_land_code'].'"  data-file_location="'.$result_extend['file_storage_location'].'"  >  <span class="text-primary"  >  <i class="fa fa-trash-o"   style="font-size:20px ;color:red;"></i> DELETE POST </span></a>
                               </td>
...
<div class="card text-white bg-light border border-info mt-2 mb-2  "  >
       ...
       <div class="card-body bg-dark" >
                          ...
                          <tbody>
                             <tr> 
                               <td width="50%" style="  color:white; border:white solid 1px; border-left: none; font-size:13px; ">  
                                <a  id="delete_extended_land_video"     style="cursor:pointer"  data-land_code="'.$result_extend_video['extend_land_code'].'"  data-file_location="'.$result_extend_video['file_storage_location'].'"  >  <span class="text-primary"  >  <i class="fa fa-trash-o"   style="font-size:20px ;color:red;"></i> DELETE POST </span></a>
                               </td>
