...
$query =mysqli_query($conn,"SELECT * FROM book_house WHERE book_code='{$book_code}'");
...
<span class="text-success"><strong><a href="index.php" class="text-success">Home</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i> Book House Details </strong></span>
...
<div class="container mt-5 mb-4 flex justify-content-center  "> 
 ...
 <table class="table" id="myTable">
    ...
    <tbody>
      <tr style="background-image: linear-gradient(to bottom right ,green,black);">
           <td width="50%" style=" text-align:end;   ">
           <span class="text-light"> House Price<i class="fa fa-caret-right" style="font-size:12px;color:red"></i> </span>
      ...
      <tr>
           <td width="50%" style="text-align:end;   ">
           <span class="text-dark"> Type <i class="fa fa-caret-right" style="font-size:12px;color:red"></i> </span>
       
           </td>
          <td width="50%"> <span class="text-success"> <?php echo $result['property']; ?> </span> </td>

         
      </tr>
      <tr  style="  background-image: linear-gradient(to bottom right ,green,black);  ">
           <td width="50%" style="text-align:end;   ">
           <span class="text-light">  Category <i class="fa fa-caret-right" style="font-size:12px;color:red"></i> </span>
           
           </td>
          <td width="50%"> <a   class="text-warning"  > <?php echo $result['category']; ?> </a> </td>
      ...
      <tr >
           <td width="50%" style="text-align:end;  ">
           <span class="text-dark">  Bedroom  <i class="fa fa-caret-right" style="font-size:12px;color:red"></i> </span>
 
           </td>
          <td width="50%"> <span class="text-success"> <?php echo $result[ 'bedroom']; ?> </span> </td>

         
      </tr>
      <tr  style=" background-image: linear-gradient(to bottom right ,green,black);  ">
           <td width="50%" style="text-align:center;  " colspan="2">
           <span class="text-light">Location <br><i class="fa fa-caret-down" style="font-size:12px;color:red"></i> </span>
      ...
      <tr>
      <td width="50%" colspan="2" style="text-align:center"> <a   class="text-danger"  ><?php echo $result['location']; ?> </a></span> </td>
