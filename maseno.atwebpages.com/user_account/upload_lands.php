...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home  <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i><a href="index.php" class="text-success"> Dashboard</a><i class="fa fa-angle-double-right" style="font-size:20px;color:red"></i>Post Land </strong> </span>
         ...
         <div class="col-lg-8">
                ...
                <div style="border: yellow solid 1px ;border-radius: 10px; margin-top:10px ;  background-image: linear-gradient(to bottom right ,black,green); padding:10px;">
                            ...
                            <div class=" d-flex justify-content-center">
                                  ...
                                  <h3 style="font-family:Cursive ;"> Sell Land </h3>
                         </span></div>
                            ...
                            <div class=" d-flex justify-content-center">
                                ...
                                <div class="text-center">
                                  <span class="text-white">LAND PRICE</span>
                                   ...
                                   <div class="input-container">
                                     ...
                                     <input  class="input-field " placeholder="PRICE" id="price" value="Ksh "  >
                                  ...
                                  <div class="text-center">
                                  <span class="text-white">PERSONAL CONTACT</span>
                                   ...
                                   <div class="input-container">
                                     ...
                                     <input  class="input-field " placeholder="TEL PHONE" id="tel_phone" value="+254"  >
                                  ...
                                  <div class="input-container">
                                  <select class="input-field text-center" id="type"  >
                                      <option value="TYPE OF LAND">TYPE OF LAND</option>
                                  ...
                                  <div class="input-container">
                                  <textarea class="input-field" placeholder="Facilities & Resources i.e AVAILABILITY OF WATER , ELECTRICITY AND etc. " id="facilities" style="min-height:150px ;"></textarea>
...
function upload_form() {
    ...
    var type =document.forms["upload_house"]["type"].value;
    var facilities =document.forms["upload_house"]["facilities"].value;
    var fd = new FormData();
    var files = $('#file')[0].files;
    var username="<?php echo $_SESSION['username']; ?>";


    if(tel_phone =="" || tel_phone == "+254" ){

var message= `
<div id = "confirm">
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;"> Enter Telphone Number</span>
</div>
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please  Enter land Size </span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Enter Location </span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Enter Description </span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Enter Price Of Land</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
if(type =="" || type =="TYPE OF LAND" ){

var message= `
<div id = "confirm">
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Select Type Of Land</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Enter facilities Available</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
if(files.length ==1 ){
                          ...
                          url: 'product_manage/send_upload_lands.php',
                          type: 'post',
                          data: fd,
                          contentType: false,
                          processData: false,
