...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home  <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i><a href="index.php" class="text-success"> Dashboard</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"></i>Change Land Photo </strong></span>
         ...
         <div class="col-lg-8">
                ...
                <div style="border: yellow solid 1px ;border-radius: 10px; margin-top:10px ;  background-image: linear-gradient(to bottom right ,black,green); padding:10px;">
                            ...
                            <div class=" d-flex justify-content-center">
                                  ...
                                  <h3 style="font-family:Cursive ;"> Change Photo </h3>
                         </span></div>
                            ...
                            <div class=" d-flex justify-content-center">
                                <form style="max-width:500px;margin:auto" name="upload_house">
                                  ...
                                  <span class="text-white">SELECT PHOTO</span>
                                   ...
                                   <div class="input-container">
                                    <button type="button" onclick="return  upload_form()" class="btn btn-success input-field text-center">Change Photo</button>
                                   </div>
...
function upload_form() {
    ...
    var file_storage_location ="<?php echo $_GET['file_location']; ?>";
...
if(files.length ==1 ){
                         ...
                         fd.append('username',username);
                          ...
                          fd.append('file_storage_location',file_storage_location);
                          ...
                          url: 'product_manage/send_edit_photo_land.php',
                          type: 'post',
                          data: fd,
                          contentType: false,
                          processData: false,
                      ...
                      var message= `
                            <div id = "confirm">
                            <div class = "message" style="text-align: center;">
                            <span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE MESSAGE</span><br>
