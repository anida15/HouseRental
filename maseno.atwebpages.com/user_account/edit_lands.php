...
?>
    ...
    <div style="width:85%; float:left;" class="bg-dark p-1">
        <span class="text-success"><strong><a href="../index.php" class="text-success">Home <i
                        class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i><a href="index.php"
                        class="text-success"> Dashboard</a> <i class="fa fa-angle-double-right"
                        style="font-size:20px;color:red"></i>Edit Land Details</strong></span>
    ...
    <div class="container  " style="  clear:both;">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-lg-8">
                ...
                <div
                    style="border: yellow solid 1px ;border-radius: 10px; margin-top:10px ;  background-image: linear-gradient(to bottom right ,black,green); padding:10px;">
                    ...
                    <div class=" d-flex justify-content-center">
                        ...
                        <span style="color:yellow" class="header_title">
                            <h3 style="font-family:Cursive ;">Update Land Details </h3>
                        </span>
                    </div>
                    ...
                    <div class=" d-flex justify-content-center">
                        <form style="max-width:500px;margin:auto" name="upload_house">
                            ...
                            <div class="input-container">
                                ...
                                <input class="input-field " placeholder="PRICE" id="price"
                            ...
                            <div class="input-container">
                                ...
                                <input class="input-field " placeholder="TEL PHONE" id="tel_phone"
                                    value="<?php echo $result['tel_phone']; ?>">
                            ...
                            <div class="input-container">
                                ...
                                <input class="input-field" type="text" placeholder="LAND DIMENSION"
                                    value="<?php echo $result['land_dimension']; ?>" id="land_dimension">
                            </div>


                            <div class="input-container">
                                <select class="input-field text-center" id="type">
                                    <option value="<?php echo $result['type']; ?>"><?php echo $result['type']; ?>
                                    </option>
                            ...
                            <div class="input-container">
                                <textarea class="input-field"
                                    placeholder="Facilities & Resources i.e AVAILABILITY OF WATER , ELECTRICITY "
                                    id="facilities" style="min-height:150px ;"></textarea>
                            ...
                            <div class="input-container">
                                <input class="  icon" value="<?php echo $result['location']; ?>" placeholder="Location"
                                    id="location">

                                <select class="input-field text-center" id="country">
                                    <option value="<?php echo $result['country']; ?>"><?php echo $result['country']; ?>
                                    </option>
                            ...
                            <div class="input-container">
                                ...
                                <textarea class="input-field" placeholder="Description" id="description"
                            ...
                            <div class="input-container">
                                <button type="button" onclick="return  upload_form()"
                                    class="btn btn-success input-field text-center">Upload Details</button>
                            </div>
...
?>
    ...
    document.getElementById("facilities").value = "<?php echo $result['facilities']; ?>";
    ...
    function upload_form() {
        ...
        var land_code = "<?php echo $_GET['land_code']; ?>";
        ...
        $.ajax({
            ...
            url: 'product_manage/send_edit_lands.php',
            type: 'post',
            data: fd,
            contentType: false,
            processData: false,
