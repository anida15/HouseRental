...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home  <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i><a href="index.php" class="text-success"> Dashboard</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"></i>Change House Photo </strong></span>
...
function upload_form() {
    ...
    var file_storage_location ="<?php echo $_GET['file_storage_location']; ?>";
...
if(files.length ==1 ){
                          ...
                          url: 'product_manage/send_edit_photo_rent_and_sell.php',
                          type: 'post',
                          data: fd,
                          contentType: false,
                          processData: false,
