...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home  <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i><a href="index.php" class="text-success"> Dashboard</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"></i>Rent | Sell House </strong></span>
         ...
         <div class="col-lg-8">
                ...
                <div style="border: yellow solid 1px ;border-radius: 10px; margin-top:10px ;  background-image: linear-gradient(to bottom right ,black,green); padding:10px;">
                            ...
                            <div class=" d-flex justify-content-center">
                                  ...
                                  <h3 style="font-family:Cursive ;"> Sell / Rent </h3>
                         </span></div>
                            ...
                            <div class=" d-flex justify-content-center">
                                <form style="max-width:500px;margin:auto" name="upload_house">
                                  ...
                                  <input class=" icon" placeholder="Bedroom count" type="number" id="bedroom">


                                      <input class="input-field" type="number" placeholder="Bathroom count" id="bathroom">
                                  </div>
 

                                  <div class="input-container">
                                  <input class="icon" placeholder="Kitchen count" type="number" id="kitchen">


                                      <input class="input-field" type="number" placeholder="Laundry count" id="laundry">
                                  </div>

 

                                  <div class="input-container">
                                    <input class="icon" placeholder="verandah count" type="number" id="verandah">
                                    <input class="input-field" type="text" placeholder="Land dimension" id="land_dimension">
                                  </div>
                                  ...
                                  <div class="input-container">
                                    <input class="  icon" placeholder="Location" id="location">
                                  ...
                                  <div class="text-center">
                                  <span class="text-white">SELECT PHOTO</span>
...
<span class="text-light" style="font-size:12px;">Please  Select Property</span>
</div>
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please  Select Category</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please  Enter Number Of Bedroom</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please Enter Number Of Bathroom</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please  Enter Number Of Kitchen</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please Enter Number Of Laundry</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please  Enter Number Of Verandah</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please Enter Land Dimension</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please  Enter Location </span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please  Select  Country</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please Type Description </span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
<div class = "message" style="text-align: center;">
<span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please  Enter Price</span>
</div>
<button class = "yes" style="color: white;">OK</button>
</div>`;
...
if(files.length ==1 ){
                          ...
                          url: 'product_manage/send_upload_sell_house_and_rent_house.php',
                          type: 'post',
                          data: fd,
                          contentType: false,
                          processData: false,
