...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home  <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i><a href="index.php" class="text-success"> Dashboard</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"></i>Application </strong></span>
         ...
         <div class="col-lg-8">
                ...
                <div style="border: yellow solid 1px ;border-radius: 10px; margin-top:10px ;  background-image: linear-gradient(to bottom right ,black,green); padding:10px;">
                            ...
                            <div class=" d-flex justify-content-center">
                                  ...
                                  <h3 style="font-family:Cursive ;"> Membership Application </h3>
                         </span></div>
                            ...
                            <div class=" d-flex justify-content-center">
                                <form style="max-width:500px;margin:auto" name="upload_house">
                                  ...
                                  <span class="text-white">FIRST NAME</span><br>
                                  <span class="text-danger">Please Confirm First Names</span>

                                  </div>
                                  
                                  <div class="input-container">
                                     
                                     <input class="input-field" style="width:260px ;" type="text" placeholder="First Name" value="<?php echo $_SESSION['first_name']; ?>" id="first_name">
                                  ...
                                  <div class="text-center">
                                  <span class="text-white">LAST NAME</span><br>
                                  <span class="text-danger">Please Confirm Last Names</span>
                                  ...
                                  <div class="input-container">
                                     ...
                                     <input class="input-field" type="text" placeholder="Last Name" value="<?php echo $_SESSION['last_name']; ?>" id="last_name">
                                  ...
                                  <div class="input-container">
                                     ...
                                     <input class="input-field" type="email" placeholder="Email" value="" id="email">
                                     ...
                                     <div >
                                       ...
                                       <span id="email_alert" class="text-danger"></span>
                                       <br> 
                                  ...
                                  <div class="input-container">
                                   ...
                                   <div class="input-container">
                                    <button type="button" onclick="return  upload_form()" class="btn btn-success input-field text-center">APPLY NOW</button>
                                   </div>
...
function upload_form() {
    ...
    var first_name =document.forms["upload_house"]["first_name"].value;
    var last_name =document.forms["upload_house"]["last_name"].value;
    var email =document.forms["upload_house"]["email"].value;
...
if(first_name==""){
    ...
    <span class="text-light" style="font-size:12px;">Please Fill First Name</span><br>
...
<div class = "message" style="text-align: center;">
<span  style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please Fill Last Name</span><br>
...
<div class = "message" style="text-align: center;">
<span  style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
<span class="text-light" style="font-size:12px;">Please Fill Email</span><br>
...
$('#email_alert').html("Wrong Email Format !!");
...
return false;
                          ...
                          url: 'product_manage/send_memberhip_application.php',
                          type: 'post',
                          data: fd,
                          contentType: false,
                          processData: false,
                          ...
                          <div id = "confirm">
                          <div class = "message" style="text-align: center;">
                          <span class="text-danger"><i class="fa fa-spinner  fa-spin" style="font-size:30px;color:red"></i></span><br>
                          ...
                          <div class = "message" style="text-align: center;">
                          <span style="color:rgba(61, 203, 13, 0.935);">CONFIRMED MESSAGE</span><br>
                          <span class="text-light" style="font-size:12px;">Membership Approved <i class="fa fa-check" style="font-size:20px;color:green"></i></span>
                          </div>
                          <button class = "yes" style="color: white;">OK</button>
                          </div>`;
