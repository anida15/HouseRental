...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home  <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i><a href="index.php" class="text-success"> Dashboard</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"></i>Add House Photo </strong></span>
         ...
         <div class="col-lg-8">
                ...
                <div style="border: yellow solid 1px ;border-radius: 10px; margin-top:10px ;  background-image: linear-gradient(to bottom right ,black,green); padding:10px;">
                            ...
                            <div class=" d-flex justify-content-center">
                                  ...
                                  <h3 style="font-family:Cursive ;"> Add <?php echo $_GET['property_type']; ?> Photo </h3>
                         </span></div>
...
if(files.length ==1 ){
                         ...
                         fd.append('username',username);
                          ...
                          url: 'product_manage/send_add_rent_and_sell_house_photo.php',
                          type: 'post',
                          data: fd,
                          contentType: false,
                          processData: false,
