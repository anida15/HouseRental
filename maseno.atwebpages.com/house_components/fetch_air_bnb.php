...
$query_fetch_house= mysqli_query($conn,"SELECT * FROM house  WHERE bedroom ='{$bedroom}' ORDER BY RAND() ");
...
<div class="card text-white bg-light border border-info mt-2 mb-2  "  >
       ...
       <div class="card-body bg-dark" >
                       ...
                       <div>
                         ...
                         <span   style="width:30%; float:right;" ><i class="fa fa-cart-arrow-down " style="font-size:15px;color:yellow"></i>  &nbsp; '.$result['category'].' <span style="font-size:10px"></span> </span>
