...
<span class="text-success"><strong><a href="../index.php" class="text-success">Home</a> <i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i> <a href="index.php" class="text-success" > Admin  </a><i class="fa fa-angle-double-right" style="font-size:20px;color:red"> </i></strong></span>
 ...
 <div class="container" style="clear:both;">
    ...
    <div class="row d-flex justify-content-center">
         ...
         <div class="col-lg-7" >
                ...
                <div  style="border: yellow solid 1px ;border-radius: 10px; margin-top:10px ;  background-image: linear-gradient(to bottom right ,black,green);">
                            ...
                            <div class=" d-flex justify-content-center">
                                  ...
                                  <h2 style="font-family:Cursive ;"> ADMIN</h2>
                                    </span>
...
function authenticate_user(){
    ...
    var user_password =document.forms["form_data"]["user_password"].value;
              ...
              return false;
                          ...
                          location.replace("../admin_account/index.php")
